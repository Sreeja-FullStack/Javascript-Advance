...
const rec = ({music:{traditional, jazz}}) =>{
 return `music venue ${traditional}, ${jazz}`   
}
console.log(rec(recommendations))

//other method

// const { beer, coffe, music: { traditional, jazz } } = recommendations;

// // const { music: { traditional, jazz } } = recommendations;

// console.log(jazz)

// const displayMusicPlaces=({ music: { traditional, jazz } })  => {
